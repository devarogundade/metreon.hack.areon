    ...
    <section id="section">
        <div class="app_width">
            <header>
                ...
                <div class="tabs">
                    <RouterLink to="/">
                        <div :class="$route.name == 'overview' ? 'tab_item_active tab_item' : 'tab_item'">
                            <p>Overview</p>
                            <div class="indicator"></div>
                        </div>
                    </RouterLink>
                    <RouterLink to="/link-dapp">
                        <div :class="$route.name == 'link' ? 'tab_item_active tab_item' : 'tab_item'">
                            <p>Link dApp</p>
                            <div class="indicator"></div>
                        </div>
                    </RouterLink>
...
<script setup>
import MetreonPayLogo from '../components/icons/MetreonPayLogo.vue';
